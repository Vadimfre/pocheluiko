...
const icons = {
  ...
  pollution: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 22h20"/>
      <path d="M6 18V9l3-3 3 3v9"/>
      <path d="M15 18v-5l3-3 3 3v5"/>
      <path d="M9 9V6"/>
      <path d="M18 10V7"/>
      <path d="M9 3v1"/>
      <path d="M18 4v1"/>
  ...
  resources: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M3.82 22c0 0 4.18-2 8.18-2 4 0 6-2 6-2"/>
      <path d="M17 8c0 0 2-4 2-6"/>
    </svg>
  ),
  protection: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  price: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 1v22" />
      <path d="M17 5.5c0-2-2.2-3.5-5-3.5S7 3.5 7 5.5s2.2 3.5 5 3.5 5 1.5 5 3.5-2.2 3.5-5 3.5-5-1.5-5-3.5" />
    </svg>
  ),
  maps: (    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
